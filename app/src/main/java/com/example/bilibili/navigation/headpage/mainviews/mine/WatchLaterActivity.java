...
public class WatchLaterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        back_mine=findViewById(R.id.btn_watchlater_back_mine);
    ...
    private void init() {
        listView=findViewById(R.id.lv_watchlater);
        List<Infor> inforlist = new ArrayList<>();

        for( int i = 1; i <= 8 ; i++) {
            Infor infor = new Infor();      //循环创建studentData 对象
            infor.setHead_source(R.drawable.video_3);
            infor.setNickname("【天气之子】天气之子，诚不欺我！百亿好电影！");          //为对象设置姓名
            infor.setWord("UP主：呼啦啦");                             //为对象设置 年龄
